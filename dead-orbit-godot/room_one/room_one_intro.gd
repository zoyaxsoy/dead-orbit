...
func _build_ui() -> void:
	...
	_hint = _lbl("Press Space to begin", 13, Color(1.0, 1.0, 1.0, 1.0), 422.0, 446.0)
	...
	_lbl_half("A / D   move",  11, Color(0.50, 0.60, 0.80, 0.70), 488.0, 504.0, true)
	_lbl_half("← / →   move", 11, Color(0.50, 0.60, 0.80, 0.70), 488.0, 504.0, false)
	_lbl_half("W   jump",      11, Color(0.50, 0.60, 0.80, 0.70), 508.0, 524.0, true)
	_lbl_half("↑   jump",      11, Color(0.50, 0.60, 0.80, 0.70), 508.0, 524.0, false)
	_lbl_half("S   button",    11, Color(0.50, 0.60, 0.80, 0.70), 528.0, 544.0, true)
	_lbl_half("↓   button",    11, Color(0.50, 0.60, 0.80, 0.70), 528.0, 544.0, false)
