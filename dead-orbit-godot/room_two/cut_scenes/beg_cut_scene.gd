...
func _build_ui() -> void:
	...
	_lbl_half("Right-Bumper/RB   Shield",     11, Color(0.50, 0.60, 0.80, 0.70), 528.0, 544.0, true)
	_lbl_half("Right-Bumper/RB   Shield",     11, Color(0.50, 0.60, 0.80, 0.70), 528.0, 544.0, false)
